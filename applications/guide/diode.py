...
#------------------------------------------------------------------        
    ...
    def intro_msg(self):
        self.clear(None)
        self.msgwin.clear()
        self.msgwin.showtext('Make the connections as shown above. LED between GND and CH0\n' +\
        'To reduce noise, connect a 1 uF capacitor from CH0 to ground.\n')
        
        self.msgwin.showlink('Start', self.start)
        self.msgwin.showtext(' generating the IV plot. Send data to ')
        ...
        self.msgwin.showlink('\nDisplay all Traces', self.show_all)
        self.msgwin.showtext(' or ')
