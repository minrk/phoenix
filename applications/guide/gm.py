...
class gm:
    ...
    def __init__(self, parent, size, plot, msg):
        ...
        self.data = Data()
        self.gmchar_volts = range(self.VMIN, self.VMAX, self.VSTEP)
...
#------------------------------------------------------------------        
    ...
    def update(self):
        ...
        if self.doing_gmchar == True:
            self.tube_voltage = self.ph.gm_set_voltage(self.gmchar_volts[self.count])
            #print self.tube_voltage
            self.count = self.count + 1
            gmc = self.ph.gm_get_count(self.duration)
            ...
            if self.count >= len(self.gmchar_volts):
                self.looping = False
    ...
    def intro_msg(self):
        ...
        self.msgwin.showtext('Tube voltage =')
        ...
        self.msgwin.showtext(' to set it. Actual Tube Voltage = ')
        ...
        self.msgwin.showtext('To plot tube Characteristic ')
