...
class mono:
    ...
    def ms_delay(self,e):
        ...
        if t < 0:
            self.msgwin.msg('Time out on Input D3','red')
            return
    ...
    def msg_intro(self):
        ...
        self.msgwin.showtext(' or Change time scale using the slider')
        ...
        self.msgwin.showtext('Connect 555 output to Digital input D3. ')
