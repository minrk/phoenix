...
class osc:
    ...
    def msg_intro(self):
        self.clear(None)
        self.msgwin.clear()
        self.msgwin.showtext('Power the 555 oscillator circuit '+\
        'from the 5V Output socket. Connect the 555 Output to CH0.\n')
        ...
        self.msgwin.showtext('. Connect it to CNTR and ')
