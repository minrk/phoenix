...
#-------------------------- Message routines -------------
    ...
    def msg_adc(self):
        self.msgwin.clear()
        self.msgwin.showtext('The Analog Inputs (CH0 to CH3) can behave like Oscilloscope '+\
          'inputs. Click on them to Enable/Disable. CH0 and CH1 can be used with the level shifting '+\
          'amplifiers to display a -5V to 5V range signal.Click on the Level shifter input socket to display '+\
          'the voltage at the level shifter input.\n')
        self.msgwin.showtext('Adjust the time base using the slider ')
        ...
        self.msgwin.showtext(' to file named ') 
        ...
        self.msgwin.showtext('\n')
        self.msgwin.showlink('Restart Scanning', self.start)
